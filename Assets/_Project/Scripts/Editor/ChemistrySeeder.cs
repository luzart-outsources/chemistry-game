...
namespace ChemistryGame.EditorTools
{
    ...
    public static class ChemistrySeeder
    {
        ...
        public static Dictionary<string, SubstanceData> SeedSubstances()
        {
            ...
            S("H2O",    "H<sub>2</sub>O",    "Nước",                       SubstanceCategoryType.Solvent,   SubstancePhase.Liquid,      7f,  new Color(0.7f, 0.9f, 1f, 0.3f));
            ...
            S("Na2CO3", "Na<sub>2</sub>CO<sub>3</sub>", "Natri cacbonat",             SubstanceCategoryType.Base,      SubstancePhase.Aqueous,    11f,  new Color(0.55f, 0.75f, 0.95f, 0.7f));
            ...
            S("AgNO3",  "AgNO<sub>3</sub>",  "Bạc nitrat",                 SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     6f,  new Color(0.85f, 0.9f, 0.95f, 0.5f));
            S("AgCl",   "AgCl",   "Bạc clorua",                 SubstanceCategoryType.Salt,      SubstancePhase.Precipitate, 7f,  new Color(0.96f, 0.96f, 0.96f, 0.95f));
            S("NaNO3",  "NaNO<sub>3</sub>",  "Natri nitrat",               SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     7f,  new Color(0.85f, 0.95f, 1f, 0.5f));
            S("Ag2O",   "Ag<sub>2</sub>O",   "Bạc oxit",                   SubstanceCategoryType.Oxide,     SubstancePhase.Precipitate, 7f,  new Color(0.18f, 0.16f, 0.14f, 0.95f));
            S("Ag2CO3", "Ag<sub>2</sub>CO<sub>3</sub>", "Bạc cacbonat",               SubstanceCategoryType.Salt,      SubstancePhase.Precipitate, 7f,  new Color(0.93f, 0.85f, 0.42f, 0.95f));
            S("HNO3",   "HNO<sub>3</sub>",   "Axit nitric",                SubstanceCategoryType.Acid,      SubstancePhase.Aqueous,     1f,  new Color(0.95f, 0.7f, 0.5f, 0.7f));
            S("CaCO3",  "CaCO<sub>3</sub>",  "Canxi cacbonat",             SubstanceCategoryType.Salt,      SubstancePhase.Solid,       7f,  new Color(0.9f, 0.9f, 0.85f, 1f));
            S("CaCl2",  "CaCl<sub>2</sub>",  "Canxi clorua",               SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     7f,  new Color(0.85f, 0.95f, 1f, 0.5f));
            S("CO2",    "CO<sub>2</sub>",    "Khí cacbonic",               SubstanceCategoryType.Gas,       SubstancePhase.Gas,         5f,  new Color(0.8f, 0.8f, 0.85f, 0.4f));
            S("H2",     "H<sub>2</sub>",     "Khí hidro",                  SubstanceCategoryType.Gas,       SubstancePhase.Gas,         7f,  new Color(0.95f, 0.95f, 1f, 0.3f));
            S("Zn",     "Zn",     "Kẽm",                        SubstanceCategoryType.Metal,     SubstancePhase.Solid,       7f,  new Color(0.65f, 0.7f, 0.75f, 1f));
            S("ZnCl2",  "ZnCl<sub>2</sub>",  "Kẽm clorua",                 SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     5f,  new Color(0.8f, 0.92f, 0.98f, 0.6f));
            S("CaOH2",  "Ca(OH)<sub>2</sub>","Canxi hidroxit (nước vôi)",  SubstanceCategoryType.Base,      SubstancePhase.Aqueous,    12f,  new Color(0.9f, 0.95f, 1f, 0.5f));
            S("H2SO4",  "H<sub>2</sub>SO<sub>4</sub>",  "Axit sunfuric",              SubstanceCategoryType.Acid,      SubstancePhase.Aqueous,     1f,  new Color(0.95f, 0.78f, 0.45f, 0.7f));
            ...
            S("CuSO4",  "CuSO<sub>4</sub>",  "Đồng sunfat",                SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     6f,  new Color(0.18f, 0.6f, 0.92f, 0.85f));
            S("CuOH2",  "Cu(OH)<sub>2</sub>","Đồng hidroxit",              SubstanceCategoryType.Base,      SubstancePhase.Precipitate, 9f,  new Color(0.32f, 0.6f, 0.92f, 0.95f));
            S("CuCl2",  "CuCl<sub>2</sub>",  "Đồng clorua",                SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     6f,  new Color(0.3f, 0.85f, 0.4f, 0.8f));
            S("Na2SO4", "Na<sub>2</sub>SO<sub>4</sub>", "Natri sunfat",               SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     7f,  new Color(0.85f, 0.95f, 1f, 0.5f));
            S("O2",     "O<sub>2</sub>",     "Khí oxi",                    SubstanceCategoryType.Gas,       SubstancePhase.Gas,         7f,  new Color(0.85f, 0.95f, 1f, 0.3f));
            S("Fe",     "Fe",     "Sắt",                        SubstanceCategoryType.Metal,     SubstancePhase.Solid,       7f,  new Color(0.45f, 0.4f, 0.4f, 1f));
            S("FeCl2",  "FeCl<sub>2</sub>",  "Sắt(II) clorua",             SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     5f,  new Color(0.5f, 0.8f, 0.55f, 0.7f));
            S("FeCl3",  "FeCl<sub>3</sub>",  "Sắt(III) clorua",            SubstanceCategoryType.Salt,      SubstancePhase.Aqueous,     5f,  new Color(0.92f, 0.78f, 0.2f, 0.85f));
            S("FeOH2",  "Fe(OH)<sub>2</sub>","Sắt(II) hidroxit",           SubstanceCategoryType.Base,      SubstancePhase.Precipitate, 9f,  new Color(0.5f, 0.78f, 0.45f, 0.95f));
            S("FeOH3",  "Fe(OH)<sub>3</sub>","Sắt(III) hidroxit",          SubstanceCategoryType.Base,      SubstancePhase.Precipitate, 9f,  new Color(0.62f, 0.34f, 0.18f, 0.95f));
            S("Cl2",    "Cl<sub>2</sub>",    "Khí clo",                    SubstanceCategoryType.Gas,       SubstancePhase.Gas,         4f,  new Color(0.85f, 0.95f, 0.6f, 0.4f));
        ...
        public static Dictionary<string, ToolData> SeedTools()
        {
            ...
            T("KSCN",         "Thuốc thử KSCN", ToolFunctionType.ReagentDropper, "KSCN", "Test Fe<sup>3+</sup> → đỏ máu");
            T("HNO3_drop",    "HNO<sub>3</sub> pha loãng", ToolFunctionType.ReagentDropper, "HNO3", "Acid hoá nhẹ");
            T("Bubble_Cl2",   "Sục Cl<sub>2</sub>",        ToolFunctionType.GasBubbler,     "Cl2",  "Sục khí clo");
            T("Bubble_O2",    "Sục O<sub>2</sub>",         ToolFunctionType.GasBubbler,     "O2",   "Sục khí oxi");
        ...
        public static Dictionary<string, ReactionRule> SeedReactions()
        {
            ...
            // ===== Màn 1 =====
            var r1 = R("HCl_NaOH",       "HCl + NaOH → NaCl + H<sub>2</sub>O",  "HCl + NaOH → NaCl + H<sub>2</sub>O",   SideEffectType.ColorFlash);
            r1.Inputs.Add(Sto("HCl",1));   r1.Inputs.Add(Sto("NaOH",1));
            r1.Outputs.Add(Sto("NaCl_aq",1));r1.Outputs.Add(Sto("H2O",1));

            var r2 = R("Na2CO3_HCl",     "Na<sub>2</sub>CO<sub>3</sub> + 2HCl → 2NaCl + CO<sub>2</sub>↑ + H<sub>2</sub>O", "Na<sub>2</sub>CO<sub>3</sub> + 2HCl → 2NaCl + CO<sub>2</sub> + H<sub>2</sub>O", SideEffectType.BubblesLarge);
            ...
            // ===== Màn 2 =====
            var r3 = R("AgNO3_NaCl",     "AgNO<sub>3</sub> + NaCl → AgCl↓ + NaNO<sub>3</sub>", "AgNO<sub>3</sub> + NaCl → AgCl↓ + NaNO<sub>3</sub>", SideEffectType.PrecipitateForm);
            r3.Inputs.Add(Sto("AgNO3",1));r3.Inputs.Add(Sto("NaCl_aq",1));
            r3.Outputs.Add(Sto("AgCl",1));r3.Outputs.Add(Sto("NaNO3",1));

            var r4 = R("AgNO3_NaOH",     "2AgNO<sub>3</sub> + 2NaOH → Ag<sub>2</sub>O↓ + 2NaNO<sub>3</sub> + H<sub>2</sub>O", "2AgNO<sub>3</sub> + 2NaOH → Ag<sub>2</sub>O + 2NaNO<sub>3</sub> + H<sub>2</sub>O", SideEffectType.PrecipitateForm);
            ...
            var r5 = R("AgNO3_Na2CO3",   "2AgNO<sub>3</sub> + Na<sub>2</sub>CO<sub>3</sub> → Ag<sub>2</sub>CO<sub>3</sub>↓ + 2NaNO<sub>3</sub>", "2AgNO<sub>3</sub> + Na<sub>2</sub>CO<sub>3</sub> → Ag<sub>2</sub>CO<sub>3</sub> + 2NaNO<sub>3</sub>", SideEffectType.PrecipitateForm);
            r5.Inputs.Add(Sto("AgNO3",2));r5.Inputs.Add(Sto("Na2CO3",1));
            r5.Outputs.Add(Sto("Ag2CO3",1));r5.Outputs.Add(Sto("NaNO3",2));

            // ===== Màn 3 =====
            var r6 = R("CaCO3_HCl",      "CaCO<sub>3</sub> + 2HCl → CaCl<sub>2</sub> + CO<sub>2</sub>↑ + H<sub>2</sub>O", "CaCO<sub>3</sub> + 2HCl → CaCl<sub>2</sub> + CO<sub>2</sub> + H<sub>2</sub>O", SideEffectType.BubblesLarge);
            ...
            var r7 = R("Zn_HCl",         "Zn + 2HCl → ZnCl<sub>2</sub> + H<sub>2</sub>↑", "Zn + 2HCl → ZnCl<sub>2</sub> + H<sub>2</sub>", SideEffectType.BubblesSmall);
            r7.Inputs.Add(Sto("Zn",1));r7.Inputs.Add(Sto("HCl",2));
            r7.Outputs.Add(Sto("ZnCl2",1));r7.Outputs.Add(Sto("H2",1));

            var r8 = R("CO2_CaOH2",      "CO<sub>2</sub> + Ca(OH)<sub>2</sub> → CaCO<sub>3</sub>↓ + H<sub>2</sub>O", "CO<sub>2</sub> + Ca(OH)<sub>2</sub> → CaCO<sub>3</sub> + H<sub>2</sub>O (nước vôi đục)", SideEffectType.PrecipitateForm);
            r8.Inputs.Add(Sto("CO2",1));r8.Inputs.Add(Sto("CaOH2",1));
            r8.Outputs.Add(Sto("CaCO3",1));r8.Outputs.Add(Sto("H2O",1));

            // ===== Màn 4 =====
            var r9 = R("CuO_H2SO4",      "CuO + H<sub>2</sub>SO<sub>4</sub> → CuSO<sub>4</sub> + H<sub>2</sub>O", "CuO + H<sub>2</sub>SO<sub>4</sub> → CuSO<sub>4</sub> + H<sub>2</sub>O", SideEffectType.ColorFlash);
            r9.Inputs.Add(Sto("CuO",1));r9.Inputs.Add(Sto("H2SO4",1));
            r9.Outputs.Add(Sto("CuSO4",1));r9.Outputs.Add(Sto("H2O",1));

            var r10 = R("Cu_O2",          "2Cu + O<sub>2</sub> -t°→ 2CuO", "2Cu + O<sub>2</sub> --t°→ 2CuO", SideEffectType.Flame);
            ...
            var r11 = R("CuSO4_NaOH",     "CuSO<sub>4</sub> + 2NaOH → Cu(OH)<sub>2</sub>↓ + Na<sub>2</sub>SO<sub>4</sub>", "CuSO<sub>4</sub> + 2NaOH → Cu(OH)<sub>2</sub> + Na<sub>2</sub>SO<sub>4</sub> (xanh kết tủa)", SideEffectType.PrecipitateForm);
            r11.Inputs.Add(Sto("CuSO4",1));r11.Inputs.Add(Sto("NaOH",2));
            r11.Outputs.Add(Sto("CuOH2",1));r11.Outputs.Add(Sto("Na2SO4",1));

            var r12 = R("CuO_HCl",        "CuO + 2HCl → CuCl<sub>2</sub> + H<sub>2</sub>O", "CuO + 2HCl → CuCl<sub>2</sub> + H<sub>2</sub>O (sai muối)", SideEffectType.ColorFlash);
            r12.Inputs.Add(Sto("CuO",1));r12.Inputs.Add(Sto("HCl",2));
            r12.Outputs.Add(Sto("CuCl2",1));r12.Outputs.Add(Sto("H2O",1));

            // ===== Màn 5 =====
            var r13 = R("Fe_HCl",         "Fe + 2HCl → FeCl<sub>2</sub> + H<sub>2</sub>↑", "Fe + 2HCl → FeCl<sub>2</sub> + H<sub>2</sub>", SideEffectType.BubblesSmall);
            r13.Inputs.Add(Sto("Fe",1));r13.Inputs.Add(Sto("HCl",2));
            r13.Outputs.Add(Sto("FeCl2",1));r13.Outputs.Add(Sto("H2",1));

            var r14 = R("FeCl2_Cl2",      "2FeCl<sub>2</sub> + Cl<sub>2</sub> → 2FeCl<sub>3</sub>", "2FeCl<sub>2</sub> + Cl<sub>2</sub> → 2FeCl<sub>3</sub> (oxi hoá)", SideEffectType.ColorFlash);
            r14.Inputs.Add(Sto("FeCl2",2));r14.Inputs.Add(Sto("Cl2",1));
            r14.Outputs.Add(Sto("FeCl3",2));

            var r15 = R("FeCl2_NaOH",     "FeCl<sub>2</sub> + 2NaOH → Fe(OH)<sub>2</sub>↓ + 2NaCl", "FeCl<sub>2</sub> + 2NaOH → Fe(OH)<sub>2</sub> + 2NaCl (xanh lá)", SideEffectType.PrecipitateForm);
            r15.Inputs.Add(Sto("FeCl2",1));r15.Inputs.Add(Sto("NaOH",2));
            r15.Outputs.Add(Sto("FeOH2",1));r15.Outputs.Add(Sto("NaCl_aq",2));

            var r16 = R("FeCl3_NaOH",     "FeCl<sub>3</sub> + 3NaOH → Fe(OH)<sub>3</sub>↓ + 3NaCl", "FeCl<sub>3</sub> + 3NaOH → Fe(OH)<sub>3</sub> + 3NaCl (nâu đỏ)", SideEffectType.PrecipitateForm);
        ...
        public static void SeedLevels()
        {
            ...
            lv1.Traps.Add(Trap("Carbonate",  "Na2CO3", "Còn Na<sub>2</sub>CO<sub>3</sub> — không tinh khiết"));
            ...
            lv1.Hints = MakeHint("Lv1",
                ...
                "HCl + NaOH → NaCl + H<sub>2</sub>O. Đong cẩn thận, dùng quỳ kiểm tra trung tính.");
            ...
            lv2.Traps.Add(Trap("Ag2O_trap",   "Ag2O",   "Bạn tạo Ag<sub>2</sub>O (đen) thay vì AgCl."));
            lv2.Traps.Add(Trap("Ag2CO3_trap", "Ag2CO3", "Bạn tạo Ag<sub>2</sub>CO<sub>3</sub> (vàng nhạt) thay vì AgCl."));
            ...
            lv2.Hints = MakeHint("Lv2",
                ...
                "Trộn AgNO<sub>3</sub> với NaCl, sau đó lọc.",
                "AgNO<sub>3</sub> + NaCl → AgCl↓ + NaNO<sub>3</sub>. Đừng dùng NaOH/Na<sub>2</sub>CO<sub>3</sub>.");

            // ===== Màn 3 — CO2 chứng minh =====
            var lv3 = L("Level_03_CO2", 3, "Điều chế CO<sub>2</sub>", "Thu CO<sub>2</sub> và chứng minh bằng nước vôi.");
            ...
            lv3.Traps.Add(Trap("WrongMetal", "ZnCl2", "Bạn dùng Zn — sinh H<sub>2</sub> chứ không phải CO<sub>2</sub>."));
            lv3.ThreeStarBlockingTraps.AddRange(lv3.Traps);
            lv3.Hints = MakeHint("Lv3",
                "Quỳ tím để phân acid; chú ý CO<sub>2</sub> và H<sub>2</sub> khác nhau.",
                "Dùng CaCO<sub>3</sub> + HCl để sinh khí. Sục vào Ca(OH)<sub>2</sub>.",
                "CaCO<sub>3</sub> + 2HCl → CaCl<sub>2</sub> + CO<sub>2</sub> + H<sub>2</sub>O. Sau đó CO<sub>2</sub> + Ca(OH)<sub>2</sub> → CaCO<sub>3</sub>↓ + H<sub>2</sub>O.");

            // ===== Màn 4 — CuSO4 =====
            var lv4 = L("Level_04_CuSO4", 4, "CuSO<sub>4</sub> tinh khiết", "Tạo dung dịch CuSO<sub>4</sub> xanh, không kết tủa.");
            ...
            lv4.Traps.Add(Trap("Hydroxide", "CuOH2", "Bạn tạo Cu(OH)<sub>2</sub> — kết tủa xanh."));
            lv4.Traps.Add(Trap("WrongSalt", "CuCl2", "Bạn tạo CuCl<sub>2</sub> thay vì CuSO<sub>4</sub>."));
            lv4.ThreeStarBlockingTraps.AddRange(lv4.Traps);
            lv4.Hints = MakeHint("Lv4",
                "H<sub>2</sub>SO<sub>4</sub> là acid sunfat — chỉ acid này tạo muối sunfat đúng.",
                "Đường ngắn: CuO + H<sub>2</sub>SO<sub>4</sub>. Đường khó (3⭐): Cu → CuO → CuSO<sub>4</sub>.",
                "CuO + H<sub>2</sub>SO<sub>4</sub> → CuSO<sub>4</sub> + H<sub>2</sub>O. Tránh NaOH (tạo Cu(OH)<sub>2</sub>).");

            // ===== Màn 5 — FeCl3 =====
            var lv5 = L("Level_05_FeCl3", 5, "FeCl<sub>3</sub> không lẫn FeCl<sub>2</sub>", "Tạo FeCl<sub>3</sub>, kiểm bằng KSCN cho đỏ máu.");
            ...
            lv5.Traps.Add(Trap("LeftOverFe2", "FeCl2", "Còn FeCl<sub>2</sub> — sục thêm Cl<sub>2</sub>."));
            lv5.Traps.Add(Trap("Hydroxide_Fe2", "FeOH2", "Bạn tạo Fe(OH)<sub>2</sub> (xanh lá) — tránh NaOH."));
            lv5.Traps.Add(Trap("Hydroxide_Fe3", "FeOH3", "Bạn tạo Fe(OH)<sub>3</sub> (nâu đỏ) — tránh NaOH."));
            lv5.ThreeStarBlockingTraps.AddRange(lv5.Traps);
            lv5.Hints = MakeHint("Lv5",
                "Fe + HCl chỉ tạo FeCl<sub>2</sub> (sắt II). Cần oxi hoá thêm.",
